# Feature Section 21st.dev Prompt
...
Repo note for the demo import:
- The snippet above uses `@/components/blocks/feature-section` as its source example.
- In this codebase, if you integrate it as a reusable UI primitive, place it under `frontend/components/ui/feature-section.tsx` and import it as `@/components/ui/feature-section`.
