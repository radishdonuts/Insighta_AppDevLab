...
Repo note for this project:
- Reusable UI components live in `frontend/components/ui`
- The shadcn config is in `frontend/components.json`
- The configured global stylesheet path is `frontend/components/styles/globals.css`
- Utility imports use `@/lib/utils`
...
Repo note for dependencies:
- `frontend/components/ui/button.tsx`, `frontend/components/ui/input.tsx`, and `frontend/components/ui/textarea.tsx` already exist in this codebase.
- Keep the dependency snippets in this doc as integration reference content.
